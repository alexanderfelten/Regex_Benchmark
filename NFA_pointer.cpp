...
int main() {
    ...
    nfa.addTransition("q0", "q1", std::make_shared<CharacterMatcher>('a'));
    nfa.addTransition("q1", "q1", std::make_shared<EpsilonMatcher>());
    nfa.addTransition("q1", "q2", std::make_shared<CharacterMatcher>('b'));
    nfa.addTransition("q2", "q2", std::make_shared<CharacterMatcher>('c'));
    nfa.addTransition("q2", "q3", std::make_shared<EpsilonMatcher>());

    std::cout << std::boolalpha;

    std::cout << nfa.compute("abbbbbb") << std::endl;
    std::cout << nfa.compute("aabbbbbb") << std::endl;
    std::cout << nfa.compute("ab") << std::endl;
    std::cout << nfa.compute("a") << std::endl;*/
    ...
    std::cout << regex.compute("a") << std::endl; //false
    std::cout << regex.compute("ac") << std::endl; //false
    std::cout << regex.compute("abc") << std::endl; //false
    std::cout << regex.compute("abbbc") << std::endl; //false
    std::cout << regex.compute("ab") << std::endl; //true
